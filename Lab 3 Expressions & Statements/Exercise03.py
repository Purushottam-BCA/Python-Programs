# <Prog_No:3> <Ex_No:2> <Author: Purushottam Kumar>
# Write a program to concatenate the following string:
...
print("\n Output of Prog_No:3 in Ex_No:2 implemented by Purushottam Kumar :\n")
